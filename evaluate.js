...
const main = async () => {
  ...
  const raw = await axois.get("https://media.extra.com/i/aurora/100315940_100_10", {responseType: 'stream',});
  console.log(raw);
  // formData.append('files.Images', raw.data, (title.split(' ').join('_')+'_'+index));
